    ...
    <section className="hero">
      <div className="container">
        ...
        <p>
          ...
          l’inclusion des enfants, en s’appuyant au quotidien sur l’écoute,          l’inclusion des enfants, en s’appuyant au quotidien sur l’écoute,
      ...
      <Link to="/contact"><img src={contact} alt="Contact" className="icon-contact" /></Link>

      <Link to="/inclusion"><img src={handicap} alt="Handicap" className="icon-handicap" /></Link>

      <a href="#" className="icon-scroll"><img src={fleches} /></a>
    </section>
  );
}
