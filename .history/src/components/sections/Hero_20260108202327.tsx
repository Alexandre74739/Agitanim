...
function Hero() {
  return (
    // Tout doit être enveloppé dans un seul élément parent (ici <section> ou <div>)
    <section className="hero">
      ...
      {/* On regroupe les icônes flottantes ou latérales pour faciliter le SCSS */}
      <div className="hero-icons">
        ...
        <Link to="/inclusion">
          <img src={handicap} alt="Handicap" className="icon-handicap" />
        </Link>
        
        {/* Correction : Pas besoin de mélanger <a> et <Link> pour une ancre interne */}
