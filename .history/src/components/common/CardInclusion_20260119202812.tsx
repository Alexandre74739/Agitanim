...
// Liste des données (vous pourriez aussi les fetcher depuis Supabase)
const cardsData = [
  ...
  { id: 5, title: "Trouble TSA", icon: "/assets/icons/brain.png", pdfUrl: "https://votre-url-supabase/tsa2.pdf" },
];
